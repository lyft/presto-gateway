...
public class TestSpecificDbResourceGroupsManager {
  ...
  public void testUpdateResourceGroup() {
    ...
    ResourceGroupsDetail updated = resourceGroupManager.updateResourceGroup(resourceGroup, specificDb);
    List<ResourceGroupsDetail> resourceGroups = resourceGroupManager.readAllResourceGroups(specificDb);
    Assert.assertEquals(resourceGroups.size(), 1);
    ...
    resourceGroupManager.updateResourceGroup(resourceGroup, specificDb);
    ...
    resourceGroups = resourceGroupManager.readAllResourceGroups(specificDb);
  ...
  public void testDeleteResourceGroup() {
    ...
    resourceGroupManager.deleteResourceGroup(resourceGroups.get(1).getResourceGroupId(), specificDb);
    resourceGroups = resourceGroupManager.readAllResourceGroups(specificDb);
  ...
  public void testCreateSelector() {
    ...
    SelectorsDetail newSelector = resourceGroupManager.createSelector(selector, specificDb);
  ...
  public void testUpdateSelector() {
    ...
    List<SelectorsDetail> selectors = resourceGroupManager.readAllSelectors(specificDb);
    SelectorsDetail updated = resourceGroupManager.updateSelector(selectors.get(0), selector, specificDb);
    selectors = resourceGroupManager.readAllSelectors(specificDb);
    ...
    selector.setQueryType(specificDb);
    selector.setClientTags(specificDb);
    selector.setSelectorResourceEstimate(specificDb);

    updated = resourceGroupManager.updateSelector(new SelectorsDetail(), selector, specificDb);
    selectors = resourceGroupManager.readAllSelectors(specificDb);
  ...
  public void testDeleteSelector() {
    ...
    Assert.assertEquals(selectors.size(), 3);
    Assert.assertEquals(selectors.get(0).getResourceGroupId(), 0L);
    resourceGroupManager.deleteSelector(selectors.get(0), specificDb);
    selectors = resourceGroupManager.readAllSelectors(specificDb);

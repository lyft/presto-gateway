...
public class QueryIdCachingProxyHandler extends ProxyHandler {
  ...
  public static final String V1_CLUSTER_PATH = "/v1/cluster"; // Deprecated
  public static final String V1_CLUSTER_STATS_PATH = "/ui/api/stats";
  ...
  private boolean isPathWhiteListed(String path) {
    return path.startsWith(V1_STATEMENT_PATH)
        ...
        || path.startsWith(V1_CLUSTER_STATS_PATH);
  }

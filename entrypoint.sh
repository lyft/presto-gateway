...
curl -s https://consul.moengage.com/v1/kv/presto-gateway/presto-gateway/gateway-ha-config.yml | jq -r '.[] | .Value' | base64 --decode > /etc/presto-gateway/gateway-ha-config.yml
